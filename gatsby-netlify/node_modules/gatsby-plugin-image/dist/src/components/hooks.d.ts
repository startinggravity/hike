...
export declare type IGatsbyImageParent<T = never> = T & {
    gatsbyImage: IGatsbyImageData;
};
export declare type FileNode = Partial<Node> & {
    childImageSharp?: IGatsbyImageDataParent<Partial<Node>>;
};
export declare type ImageDataLike = FileNode | IGatsbyImageDataParent | IGatsbyImageParent | IGatsbyImageData;
