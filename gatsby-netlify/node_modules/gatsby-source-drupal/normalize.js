...
exports.nodeFromData = exports.isFileNode = exports.imageCDNState = exports.getHref = exports.generateTypeName = exports.downloadFile = exports.createNodeIdWithVersion = void 0;
...
const generateTypeName = (type, typePrefix = ``) => {
  const prefixed = typePrefix ? `${capitalize(typePrefix)}${capitalize(type)}` : type;
...
const isFileNode = (node, typePrefix = ``) => {
  var _node$internal;
  if (!fileNodeTypes.has(typePrefix)) {
    fileNodeTypes.set(typePrefix, new Set([generateTypeName(`files`, typePrefix), generateTypeName(`file--file`, typePrefix)]));
  }
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  return fileNodeTypes.get(typePrefix).has(node === null || node === void 0 ? void 0 : (_node$internal = node.internal) === null || _node$internal === void 0 ? void 0 : _node$internal.type);
};
